...
//            }
        ...
        //   Image image = ImageIO.read(this.getClass().getResource("/img/food.PNG"));
         ...
         //  labels[i] = new JLabel(imageIcon);
	       ...
	       gbc.gridx++; // move to next column
               //image
               button[i].addActionListener((ActionListener) new ClickAddCart(new Product(list.get(i).getId(),
    ...
    private void initComponents() {
        ...
        jLabel16.setText("TFOODs");
        sidepane.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, -1, -1));
