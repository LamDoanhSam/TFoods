      ...
      int result = NO_SUCH_PAGE;    
        ...
        try{
          ...
          String RecievedString="0 VNĐ";
            ...
            g2d.drawString("*************************************",10,y);y+=yShift;
            g2d.drawString("       THANK YOU AND SEE YOU AGAIN            ",10,y);y+=yShift;
            g2d.drawString("*************************************",10,y);y+=yShift;
            g2d.drawString("       SOFTWARE BY:TFoods          ",10,y);y+=yShift;
            g2d.drawString("   CONTACT:  doanhsam2692001@gmail.com       ",10,y);y+=yShift;       
